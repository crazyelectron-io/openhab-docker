...
- [Table of Contents](#table-of-contents)
  ...
  - [Common problems](#common-problems)
    - [Error: KARAF\_ETC is not valid](#error-karaf_etc-is-not-valid)
    - [Missing some preinstalled package](#missing-some-preinstalled-package)
    - [No logging after "Launching the openHAB runtime..."](#no-logging-after-launching-the-openhab-runtime)
    - [OpenJDK Client VM warning: No monotonic clock was available](#openjdk-client-vm-warning-no-monotonic-clock-was-available)
...
* **Milestone:** Intermediary releases of the next openHAB version which are released about once a month. They include recently added features and bugfixes and are a good compromise between the current stable version and the bleeding-edge and potentially unstable snapshot version.
  * `3.4.0.M4` ([Release notes](https://github.com/openhab/openhab-distro/releases/tag/3.4.0.M4))
  * `3.4.0.M3` ([Release notes](https://github.com/openhab/openhab-distro/releases/tag/3.4.0.M3))
